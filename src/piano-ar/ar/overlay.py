...
# build_keys() index 0 represents C4. Change this only when the first key
# generated by the keyboard layout changes to a different MIDI note.
FIRST_VISIBLE_MIDI_NOTE = 60  # C4
